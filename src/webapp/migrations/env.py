...
from tron_api.models import TronAddressInfo
...
config.set_section_option(section, "PORT", settings.db.PORT)
config.set_section_option(section, "NAME", settings.db.NAME)
config.set_section_option(section, "USER", settings.db.USER)
config.set_section_option(section, "PASS", settings.db.PASS)
